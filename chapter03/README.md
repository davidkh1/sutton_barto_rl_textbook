...
Reproductions and solutions of examples and problems from Chapter 3 of
[Reinforcement Learning: An Introduction, 2nd edition](http://incompleteideas.net/book/the-book-2nd.html).

## Exercises

- Exercise 3.5: Dynamics for episodic tasks — [derivation (LaTeX)](exercise_3_5.tex) and [PDF](results/exercise_3_5.pdf)
